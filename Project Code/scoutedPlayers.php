...
// 2. CHECK PERMISSIONS (Head/Assistant Coach Only)
$can_manage = false;
if ($user_role == 'coach') {
                ...
                ?>
                    ...
                    <div class="card-body">
                        <div class="stat-row">
                            ...
                            <div class="stat"><span class="lbl">Height</span><span class="val"><?php echo $row['Height']; ?>cm</span></div>
                            <div class="stat"><span class="lbl">Weight</span><span class="val"><?php echo $row['Weight']; ?>kg</span></div>
                        </div>
