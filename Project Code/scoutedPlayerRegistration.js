document.addEventListener('DOMContentLoaded', function () {
    ...
    // When user changes the date picker, this math runs automatically
    ...
    registrationForm.addEventListener('submit', function(e) {
        ...
        const requiredIds = [
            'player_name', 'age', 'date_of_birth', 'phone_no', 
            'height', 'weight', 'preferred_foot', 'injury_status',
            'position', 'previous_club', 'experience', 'bio'
        ];
