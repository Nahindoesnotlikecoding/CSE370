                ...
                <div class="details-box">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="val status-fit"><?php echo htmlspecialchars($data['Coach_Availability']); ?></div>
                        </div>
                        ...
                        <div class="info-item">
                            <label>NID</label>
                            <div class="val"><?php echo $data['NID'] ? htmlspecialchars($data['NID']) : 'N/A'; ?></div>
                        </div>
                        ...
                        <div class="info-item full">
                            <label>Address</label>
                            <div class="val"><?php echo $data['Address'] ? htmlspecialchars($data['Address']) : 'N/A'; ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="info-content">
                    <div class="stats-row">
                        <div class="stat-pill">
                            ...
                            <span class="num" style="color: #16a34a; font-size: 1.3rem;">$<?php echo number_format($data['salary']); ?></span>
                        </div>
                        <div class="stat-pill">
                            <span class="lbl">Start Date</span>
                            <span class="num" style="font-size: 1rem;"><?php echo $data['contract_start_date']; ?></span>
                        </div>
                        <div class="stat-pill">
                            <span class="lbl">End Date</span>
                            <span class="num" style="font-size: 1rem;"><?php echo $data['contract_end_date']; ?></span>
                        </div>
                    </div>
                </div>
            </div>
